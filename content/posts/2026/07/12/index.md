...
tags = ["投資"]
description = "成田国際空港周辺開発に対する出資を募っていた例の件がどうなったのか気になったので調べていたのだが、集団訴訟が起こっているようである。「成田国際空港周辺開発、一口100万円、想定利回り7%、5年間で償還」という条件を見て、出資判断をどうするべきであったか、あくまで個人として認識している範囲で整理し、ブログに書いておくことにした。答え合わせが目的ではなく、投資をするにあたっては過去の数字を見ること、出資による利回りの性質が何になりそうかを自分で確かめること、の2点が重要であると改めて認識したい。"
draft = false
categories = ["Money"]
+++
